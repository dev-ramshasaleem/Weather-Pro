...
import { formatDate, formatTemperature, getWeatherIcon } from "../services/weather";
    ...
    <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
      ...
      <div className="space-y-4">
        {dailyItems.map((item, index) => {
          ...
          return (
            <div className="flex items-center justify-between p-5 bg-white/5 backdrop-blur-sm rounded-2xl hover:bg-white/10 transition-all duration-300 group border border-white/20" key={index}>
