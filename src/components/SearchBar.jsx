      ...
      <form className="relative" onSubmit={handleSubmit}>
        <div className="relative group">
          ...
          <input
            ...
            className="w-full pl-12 pr-24 py-4 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl text-white placeholder-white/50 focus:outline-none  transition-all duration-300 hover:bg-white/20"
          />
        ...
        <div className="absolute top-full left-0 right-0 mt-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden z-50">
          ...
          {searchLoading ? (
            <div className="p-6 text-center text-white/70">
              <div className="animate-apin rounded-full h-6 w-6 border-2 border-white/30 border-t-white mx-auto"></div>
              <p>Search Cities</p>
            </div>
          ) : (
            suggestions.map((city, index)=>{
              ...
              <button
                ...
                className="w-full px-4 py-4 text-left mt-3 hover:bg-white/10 transition-all duration-200 flex items-center justify-between group border-b border-white/10 last:border-b-0"
